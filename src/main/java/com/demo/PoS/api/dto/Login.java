...
@Schema(name = "Login", description = "Username and password for getting a bearer token.")
...
public class Login {
  ...
  */
  ...
  @Schema(name = "password", example = "admin123", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
